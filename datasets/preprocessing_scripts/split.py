...
class DatasetSplitter:
    ...
    def split_data(
        ...
        return train_test_split(data, test_size, random_state)
...
if __name__ == "__main__":
    try:
        # Define paths
        source_path: Path = BASE_PATH.parent / "processed_merged_dataset.csv"
        output_path_train: Path = BASE_PATH.parent / "train_set.csv"
        output_path_test: Path = BASE_PATH.parent / "test_set.csv"
