...
def expected_raw_data() -> MyDict:
    ...
    return {
        "file_paths": [
            ...
            Path(
                "/tests/scraping/leetcode/test_utils/mock_files/mock_files2/distant-barcodes.py"
            ),
            Path(
                "/tests/scraping/leetcode/test_utils/mock_files/mock_files2/my-calendar-i.py"
            ),
        ],
        "files": [
