...
from src.scraping.leetcode_solutions.src.utils import MyDict
...
def expected_raw_data() -> MyDict:
    ...
    return {
        "file_paths": [
            Path("/tests/scraping/leetcode/test_utils/mock_files/mock_files2/distant-barcodes.py"),
            Path("/tests/scraping/leetcode/test_utils/mock_files/mock_files2/my-calendar-i.py"),
            Path(
                "/tests/scraping/leetcode/test_utils/mock_files/mock_files1/split-concatenated-strings.py"
            ),
            Path(
                "/tests/scraping/leetcode/test_utils/mock_files/mock_files1/complete-binary-tree-inserter.py"
            ),
        ],
        "files": [
