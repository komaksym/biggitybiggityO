...
def expected_parsed_data() -> tuple[dict[str, list[str]], list[Path]]:
    return (
        ...
        [
            Path(
                "biggitybiggityO/tests/scraping/leetcode/test_parse/mock_files/mock_files2/my-calendar-i.py"
            ),
            Path(
                "biggitybiggityO/tests/scraping/leetcode/test_parse/mock_files/mock_files1/complete-binary-tree-inserter.py"
            ),
        ],
    )
