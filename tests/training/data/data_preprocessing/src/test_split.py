import pytest
from data.preprocessing_scripts.scripts.split import DatasetSplitter
from data.preprocessing_scripts.scripts.utils import read_data
...
def test_DatasetSplitter(
    ...
    # Remove files
    dummy_train_set_path.unlink(missing_ok=True)
    dummy_test_set_path.unlink(missing_ok=True)
